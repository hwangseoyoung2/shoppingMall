...
public class PaymentService {
	...
	//결제 취소
	@Transactional
	public void refundRequest(CancleRequest cancleRequest, String access_token) throws IOException {
	    ...
	    JsonObject json = new JsonObject();
	    json.addProperty("cancel_request_amount", cancleRequest.getCancle_request_amount());
