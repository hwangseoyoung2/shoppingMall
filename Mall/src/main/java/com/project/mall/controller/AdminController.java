...
import com.project.mall.service.CanclePaymentService;
...
public class AdminController {
	...
	@Autowired
	CanclePaymentService canclePaymentService;
	...
	public String AllRefundList(Model model, @RequestParam(value="page", defaultValue = "0") int page) {
		Page<CanclePayment> refundList = canclePaymentService.findByAllRefundList(page);
	...
	public String refundInfo(Model model, @RequestParam("impUid") String impUid) {
		List<CanclePayment> refundUid = canclePaymentService.selectOne(impUid);
