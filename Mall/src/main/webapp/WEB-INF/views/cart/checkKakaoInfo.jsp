...
<body>
	  <div class="container">
	    ...
	    <table>
	      <tr>
	        <th>이름</th>
	        <td><input type="text" id="name" name="name" value="${kakaoUser.name }"></td>
	      </tr>
	      <tr>
	        <th>핸드폰 번호</th>
	      ...
	      <tr>
	        <th>주소</th>
	        <td><input type="text" id="address" name="address" required readonly></td>
	      </tr>
	      <tr>
	        <th>상세주소</th>
	        <td><input type="text" id="detailAddress" name="detailAddress" required></td>
	      </tr>
	      <tr>
	        <th>주문 상품</th>
	    ...
	    <input type="hidden" id="email" name="email" value="${kakaoUser.email }">
	  </div>
